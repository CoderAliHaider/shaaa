                ...
                <div className="w-full p-5 flex justify-between gap-2  items-center text-center">
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-white text-xs md:text-base">365 Cal</span>
                    </div>
                  </div>
                  <div className="flex text-xl md:text-3xl items-center text-[#ED3937] gap-1 text-3xl font-semibold">
                    <span className="">
                      <Image
                        src={"/images/yen.png"}
                        alt="calories"
