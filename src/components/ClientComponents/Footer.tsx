  ...
  return (
    <div className="bg-[#231F20] text-[#ED3937] pt-10 pb-5">
      <div className="container mx-auto px-6 md:px-20 lg:px-30">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-8 border-b border-[#ffffff33]">
          ...
          <div className="text-center flex gap-4 md:gap-40 text-xs md:text-sm">
            <div className="mb-3 flex gap-2 items-center">
              <div>
              <a href="#" className="text-[#ED3937]  hover:text-white border flex justify-center items-center border-[#ED3937] rounded-[50px] h-[25px] w-[25px] ">
              ...
              <div>
                ...
                <p className=" text-left  text-[#8D8C8E]">549533944</p>
              </div>
            </div>
            <div className="mb-3 flex gap-2 items-center">
              <div>
              ...
              <div>
                ...
                <p className=" text-left  text-[#8D8C8E]">smedia@shaa.com.sa</p>
              </div>
            </div>
          </div>
          <div className="flex gap-4 text-[#231F20] text-md ">
            <a href="#" className="hover:text-white border flex justify-center items-center border-[#ED3937] rounded-[50px] h-[25px] w-[25px]  bg-[#ED3937]">
        ...
        <div className="text-center  flex flex-col md:flex-row  justify-between text-xs text-[#676668] pt-4">
